...
#include "ur5e_cell_manipulation/manipulation_static_scenario.hpp"
  ...
  : node_(node), planning_group_(planning_group)
{
  ...
  node_->declare_parameter(
      "behavior_file",
      ament_index_cpp::get_package_share_directory("ur5e_cell_manipulation").append("/config/static_bt.xml"));
}
